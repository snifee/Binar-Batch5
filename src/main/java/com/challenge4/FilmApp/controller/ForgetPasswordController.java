...
import com.challenge4.FilmApp.dao.request.ResetPasswordModel;
...
public class ForgetPasswordController {
    ...
    public Map sendEmailPassword(@RequestBody ResetPasswordModel user) {
        ...
        if (StringUtils.isEmpty(found.getOtp())) {
            ...
            template = template.replaceAll("\\{\\{USERNAME}}", (found.getUsername1() == null ? "" + "@UserName" : "@" + found.getUsername1()));userRepository.save(found);
        } else {
